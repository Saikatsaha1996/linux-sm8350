 ...
 * Copyright (c) 2023 Saikat Saha <ssaikatsaha1996@gmainl.com>
 *
...
{
        //printk("Focaltech FTS: Chip id is: 0x%02x", id); //Hack for new chip id support
	if (id != CHIP_TYPE_3658U && id != CHIP_TYPE_5452 && id != CHIP_TYPE_8719)
		return false;
